                 ...
                 font-medium text-xl   relative group pt-10'>
                        ...
                        <div className='absolute left-1/2 transform -translate-x-1/2 -top-2 w-0 h-0 border-l-8 border-r-8 border-b-8 border-transparent border-b-[#f26d21]'></div>
                            <ul className='text-xl bg-gray-300'>
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>FAQs</li>
                                ...
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>More</li>
                                ...
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>Swayam</li>
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>NPTEL</li>
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>NDL</li>
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>ePathshala</li>
                                <li className='py-3 pl-2 border-b-2 hover:bg-gray-200'>NAR</li> */}
