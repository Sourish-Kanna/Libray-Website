        ...
        <div className="hidden lg:flex-grow lg:flex items-center justify-between w-full mt-2 pl-48">
          <ul className="flex items-center justify-between w-full font-serif flex-nowrap">
            ...
            <li>
              ...
              >
                <div class="text-[#014da1] font-medium mr-4 text-xl hover:active:text-[#f26d21]">
                  Login
                </div>
                <button class="w-12 h-12 bg-gray-400 hover:cursor-pointer rounded-full flex items-center justify-center text-white text-lg">
                  Pic
                </button>
              </NavLink>
            </li>
